//-----------------------------------------------------------------------------
// figure 0085: t2_0/smom  : (P1+P2) rpc04b0s54r0100, fit 120-135
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0085(int Figure, int Print) {
  ...
  const char* hist_name  = "t2_1/smom_1";
...
//------------------------------------------------------------------------------
  ...
  cbx->init_parameters(120,128.4,0.15,5.7,1.2,2.2,0.8,0.5);
  cbx->fit(120,135);
