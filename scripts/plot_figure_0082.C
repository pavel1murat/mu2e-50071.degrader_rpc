//-----------------------------------------------------------------------------
// trk_0/p  : fit (P1+P2) rpc07b0
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0082(int Figure, int Print) {
    
  const char* rpc07b0s54 = "pipenu.rpc07b0s54r0100";
  ...
  const char* hist_name  = "t2_0/smom_1";
...
// 
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,book,rpc07b0s54,ana_job,ana_module,hist_name);
  ...
  cbx->init_parameters(114,128.5,0.58,3.2,3,2,1.3,2.);
  cbx->fit(120,135);
