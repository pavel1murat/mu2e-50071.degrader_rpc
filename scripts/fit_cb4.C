...
//
// primary source: https://githib.com/pavel1murat/murat/scripts/fit_cb4.C
// usage:
// ------
...
// scan a range of momenta because an equation
//
// x+e(x) = c
//
// doesn't seem to have an analytical solution 
// 
...
//-----------------------------------------------------------------------------
// fCore, fHCore - representation of the core component, to display
//-----------------------------------------------------------------------------
