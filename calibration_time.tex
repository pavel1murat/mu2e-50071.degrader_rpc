...
\item
  \kate{For a yield of $10^{-13}$ events/POT, collecting 1000 events requires $10^{16}$ protons on target.
...
\item
  ...
  $10^{16}/( 0.1 \cdot 0.5 \cdot  2.7 \times 10^{12}) \sim 10^5$ seconds,} or about one day of running.
\item
